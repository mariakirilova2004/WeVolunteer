...
namespace WeVolunteer.Infrastructure.Migrations
{
    ...
    [Migration("20221109123838_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeVolunteer.Core.Data.Entities.Account.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7933d930-4f18-4674-a5f4-018050283fc0",
                            Email = "user@mail.com",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEByAkIAk5+InmQNo6CqkK426Wc2sf5uMO/4C/0s9+/Zwez6PK+jjXPKuCUGb7D9KLA==",
                            PhoneNumber = "0888888888",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d72ea964-7509-4d5f-9091-33124883af2c",
            ...
            modelBuilder.Entity("WeVolunteer.Core.Data.Entities.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WeVolunteer.Infrastructure.Data.Entities.PhotoEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WeVolunteer.Core.Data.Entities.Category", b =>
                {
                    b.HasOne("WeVolunteer.Core.Data.Entities.Event", null)
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("WeVolunteer.Infrastructure.Data.Entities.PhotoEvent", b =>
                {
                    b.HasOne("WeVolunteer.Core.Data.Entities.Event", "Event")
                        .WithMany("Photos")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
